...
impl TestApp {
    pub async fn new() -> Self {
        let user_store = HashmapUserStore{ users: HashMap::new()};
        let app_store = AppState::new(Arc::new(RwLock::new(user_store)));
        let app = Application::build(app_store,"127.0.0.1:0")
            .await
